...
public class BuildCategory {
	...
	public static String OHLCategory(String title) {
		
		StringBuilder builder = new StringBuilder();
		builder.append(OHLTeamName.PARENT_CATEGORY);
		builder.append(Constants.SPACE);
		builder.append(Constants.RIGHT_ARROW);
		builder.append(Constants.SPACE);
		
		if (title.toLowerCase().contains(OHLTeamName.Barrie_Colts_FULL_NAME.toLowerCase())) {
			builder.append(OHLTeamName.CANADA_CATEGORY);
			builder.append(Constants.SPACE);
			builder.append(Constants.RIGHT_ARROW);
			builder.append(Constants.SPACE);
			...
			builder.append(OHLTeamName.USA_CATEGORY);
			builder.append(Constants.SPACE);
			builder.append(Constants.RIGHT_ARROW);
			builder.append(Constants.SPACE);
