...
public class CheckSportBrand {
	public static boolean isNFLTeam(String title) {
	...
	public static boolean isNHLTeam(String title) {
	...
	public static boolean isMLBTeam(String title) {
		...
		if (title.toLowerCase().contains(MLBTeamName.PARENT_CATEGORY.toLowerCase())) {
			...
			result = true;
			return result;
		} else if (title.toLowerCase().toLowerCase()
				.contains(MLBTeamName.San_Francisco_Giants_FULL_NAME.toLowerCase())) {
			result = true;
			return result;
			...
			return result;
				...
				.contains(MLBTeamName.Washington_Nationals_FULL_NAME.toLowerCase())) {
			result = true;
			return result;
		}
		return result;
	...
	public static boolean isAFLTeam(String title) {
		boolean result = false;

		if (title.toLowerCase().contains(AFLTeamName.PARENT_CATEGORY.toLowerCase())) {
			result = true;
			return result;
		} else if (title.toLowerCase().contains(AFLTeamName.Port_Adelaide_FULL_NAME.toLowerCase())) {
			result = true;
			return result;
	...
	public static boolean isNRLTeam(String title) {
		boolean result = false;
		if (title.toLowerCase().contains(NRLTeamName.PARENT_CATEGORY.toLowerCase())) {
			result = true;
			return result;
		} else if (title.toLowerCase().contains(NRLTeamName.Brisbane_Broncos_FULL_NAME.toLowerCase())) {
			result = true;
			return result;
	...
	public static boolean isNLLTeam(String title) {
		boolean result = false;
		if (title.toLowerCase().contains(NLLTeamName.PARENT_CATEGORY.toLowerCase())) {
			result = true;
			return result;
		} else if (title.toLowerCase().contains(NLLTeamName.Albany_FireWolves_FULL_NAME.toLowerCase())) {
			result = true;
			return result;
